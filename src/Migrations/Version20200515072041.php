 ...
 */
final class Version20200515072041 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD picture VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE full_name full_name VARCHAR(255) DEFAULT NULL, CHANGE pseudo pseudo VARCHAR(255) DEFAULT NULL, CHANGE birthdate birthdate DATE DEFAULT NULL, CHANGE address address INT DEFAULT NULL, CHANGE gender gender VARCHAR(255) DEFAULT NULL');
    }
