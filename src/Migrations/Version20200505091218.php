 ...
 */
final class Version20200505091218 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sport_category (id INT AUTO_INCREMENT NOT NULL, sport_name VARCHAR(255) NOT NULL, sport_photo_collection LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
