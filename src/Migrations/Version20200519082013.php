 ...
 */
final class Version20200519082013 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_sport_category (user_id INT NOT NULL, sport_category_id INT NOT NULL, INDEX IDX_5B6B3922A76ED395 (user_id), INDEX IDX_5B6B39227173D9A4 (sport_category_id), PRIMARY KEY(user_id, sport_category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE user_sport_category ADD CONSTRAINT FK_5B6B3922A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_sport_category ADD CONSTRAINT FK_5B6B39227173D9A4 FOREIGN KEY (sport_category_id) REFERENCES sport_category (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE user_sport_category');
